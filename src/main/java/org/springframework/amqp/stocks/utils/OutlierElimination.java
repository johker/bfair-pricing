package org.springframework.amqp.stocks.utils;
...
import org.springframework.amqp.rabbit.stocks.dto.DataPriceComparator;
import org.springframework.amqp.stocks.exception.InsufficientDataException;
...
public class OutlierElimination {
	 ...
	 */
	public static List<IData> byQuartiles(List<IData> items) throws InsufficientDataException {
		if(items.size() < 4) {
